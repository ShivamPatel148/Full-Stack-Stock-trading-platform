  ...
  return (
    <div className="container mt-5">
      <div className="row text-center ">
        ...
        <div className="col-4 p-3 mt-5">
        <img style={{maxWidth:"70%", height:"55%"}}
        ...
        <div className="col-4 p-3 mt-5">
          <img style={{maxWidth:"70%"}} src= "./Images/zerodhaFundhouse.png" />
          <p className="text-small text-muted">Assest management</p>
        </div>
        <div className="col-4 p-3 mt-5">
          <img  style={{maxWidth:"70%", height:"55%"}}src= "./Images/goldenpiLogo.png" />
          <p className="text-small text-muted">Bonds trading platform</p>
        </div>
        <div className="col-4 p-3 mt--5">
          <img style={{maxWidth:"60%", height:"55%"}} src= "./Images/dittoLogo.png" />
          <p className="text-small text-muted">insurance</p>
        </div>
        <button className="p-2 btn btn-primary fs-5 mt-5 mb-5" style={{width:"20%", margin: "0 auto"}}>Signup</button>
      </div>
    </div>
  );
}
