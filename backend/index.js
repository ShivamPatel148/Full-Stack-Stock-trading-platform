...
app.get("/allHolding", async (req, res) => {
  let allHolding = await HoldingModel.find({}); //to fetch the user data
  res.json(allHolding);
});

app.get("/allPosition", async (req, res) => {
  let allPosition = await PositionModel.find({}); //to fetch the user data
...
app.post("/newOrder", async (req, res) => {
  ...
  newOrder.save(); //Inserting into database
